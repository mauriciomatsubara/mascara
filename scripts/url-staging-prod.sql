UPDATE wp_options SET option_value = replace(option_value, 'https://mascara.teste.pro.br', 'https://www.masklife.com.br') WHERE option_name = 'home' OR option_name = 'siteurl';
