UPDATE wp_options SET option_value = replace(option_value, 'https://www.masklife.com.br', 'https://mascara.teste.pro.br') WHERE option_name = 'theme_mods_flatsome-child' OR option_name = 'home' OR option_name = 'siteurl';
