...
class Helpers {
	...
	public function isWooCommerceShopPage() {
		return $this->isWooCommerceActive() && function_exists( 'is_shop' ) && is_shop();
	}
	...
	public function getVueData( $page = null ) {
		...
		if ( 'post' === $screen->base ) {
			...
			$data['currentPost'] = [
				...
				'maxSnippet'                  => (int) $post->robots_max_snippet,
				'maxVideoPreview'             => (int) $post->robots_max_videopreview,
	...
	*/
	...
	/**
	 * Escapes a string that will be inserted into a regex pattern.
	 *
	 * We need to do this as strings might contain the delimiter, e.g. URLs. We assume the delimiter is a forward slash.
	 *
	 * @since 4.0.5
	 *
	 * @param  string $string The string.
