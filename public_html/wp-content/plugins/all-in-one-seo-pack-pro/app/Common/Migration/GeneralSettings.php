...
class GeneralSettings {
	...
	public function __construct() {
		...
		$settings = [
			...
			'aiosp_google_analytics_id'        => [ 'type' => 'string', 'newOption' => [ 'webmasterTools', 'googleAnalytics', 'id' ] ],
			'aiosp_ga_advanced_options'        => [ 'type' => 'boolean', 'newOption' => [ 'webmasterTools', 'googleAnalytics', 'advanced' ] ],
			'aiosp_ga_domain'                  => [ 'type' => 'string', 'newOption' => [ 'webmasterTools', 'googleAnalytics', 'trackingDomain' ] ],
			'aiosp_ga_multi_domain'            => [ 'type' => 'boolean', 'newOption' => [ 'webmasterTools', 'googleAnalytics', 'multipleDomains' ] ],
			'aiosp_ga_addl_domains'            => [ 'type' => 'string', 'newOption' => [ 'webmasterTools', 'googleAnalytics', 'additionalDomains' ] ],
			'aiosp_ga_anonymize_ip'            => [ 'type' => 'boolean', 'newOption' => [ 'webmasterTools', 'googleAnalytics', 'anonymizeIp' ] ],
			'aiosp_ga_display_advertising'     => [ 'type' => 'boolean', 'newOption' => [ 'webmasterTools', 'googleAnalytics', 'displayAdvertiserTracking' ] ],
			'aiosp_ga_exclude_users'           => [ 'type' => 'array', 'newOption' => [ 'webmasterTools', 'googleAnalytics', 'excludeUsers' ] ],
